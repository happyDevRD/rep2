...
/**
 * <p>Clase Java para MetadatoGrupoAtribRequest complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="MetadatoGrupoAtribRequest"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "MetadatoGrupoAtribRequest", propOrder = {
    "desGruAtrib",
    "etiGruAtrib",
    "filtrable",
    "idAtrib",
...
public class MetadatoGrupoAtribRequest {

    @XmlElementRef(name = "desGruAtrib", namespace = "http://request.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "filtrable", namespace = "http://request.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<Short> filtrable;
    @XmlElementRef(name = "idAtrib", namespace = "http://request.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "modificable", namespace = "http://request.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<Short> modificable;
    @XmlElementRef(name = "numOrdPanta", namespace = "http://request.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<Short> numOrdPanta;
    @XmlElementRef(name = "requerido", namespace = "http://request.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<Short> requerido;
    @XmlElementRef(name = "reservado", namespace = "http://request.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<Short> reservado;
    @XmlElementRef(name = "valInici", namespace = "http://request.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> valInici;
    @XmlElementRef(name = "valMaxim", namespace = "http://request.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> valMaxim;
    @XmlElementRef(name = "valMinim", namespace = "http://request.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "visible", namespace = "http://request.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
