...
/**
 * <p>Clase Java para ConsultaObjetoIaeResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="ConsultaObjetoIaeResponse"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="actividad" type="{http://dto.gf.gos.greenaall.es/xsd}IaeWS" minOccurs="0"/&gt;
...
@XmlType(name = "ConsultaObjetoIaeResponse", propOrder = {
    "actividad",
    "codigoRespuesta",
    "descripcion"
})
public class ConsultaObjetoIaeResponse {

    @XmlElementRef(name = "actividad", namespace = "http://response.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<IaeWS> actividad;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link IaeWS }{@code >}
     *     
     */
    public JAXBElement<IaeWS> getActividad() {
        return actividad;
    }
     ...
     *     
     */
    public void setActividad(JAXBElement<IaeWS> value) {
