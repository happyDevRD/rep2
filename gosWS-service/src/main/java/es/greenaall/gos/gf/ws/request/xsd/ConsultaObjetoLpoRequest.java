...
/**
 * <p>Clase Java para ConsultaObjetoLpoRequest complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="ConsultaObjetoLpoRequest"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="datosConexion" type="{http://ws.dto.pe.gos.greenaall.es/xsd}DatosConexion" minOccurs="0"/&gt;
 *         &lt;element name="ocupacion" type="{http://request.ws.gf.gos.greenaall.es/xsd}LpoRequest" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ConsultaObjetoLpoRequest", propOrder = {
    "datosConexion",
    "ocupacion"
})
public class ConsultaObjetoLpoRequest {
    ...
    @XmlElementRef(name = "ocupacion", namespace = "http://request.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<LpoRequest> ocupacion;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link LpoRequest }{@code >}
     *     
     */
    public JAXBElement<LpoRequest> getOcupacion() {
        return ocupacion;
    }
     ...
     *     
     */
    public void setOcupacion(JAXBElement<LpoRequest> value) {
