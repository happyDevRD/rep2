 ...
 *         &lt;element name="numRegis" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "AltaRegistroResponse", propOrder = {
    "codigoRespuesta",
    "descripcion",
    "fecRegis",
    "numRegis"
...
public class AltaRegistroResponse {
    ...
    @XmlElementRef(name = "fecRegis", namespace = "http://response.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> fecRegis;
    @XmlElementRef(name = "numRegis", namespace = "http://response.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> numRegis;
     ...
     *     
     */
    public JAXBElement<String> getNumRegis() {
        return numRegis;
    }
     ...
     *     
     */
    public void setNumRegis(JAXBElement<String> value) {
        this.numRegis = value;
    }
