...
/**
 * <p>Clase Java para AutoLiquidacionInternetHRequest complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="AutoLiquidacionInternetHRequest"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "AutoLiquidacionInternetHRequest", propOrder = {
    "datosConexion",
    "numDocum"
})
public class AutoLiquidacionInternetHRequest {
