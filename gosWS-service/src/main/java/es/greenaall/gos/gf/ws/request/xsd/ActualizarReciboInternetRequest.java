...
/**
 * <p>Clase Java para ActualizarReciboInternetRequest complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="ActualizarReciboInternetRequest"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ActualizarReciboInternetRequest", propOrder = {
    "autorizacion",
    "datosConexion",
    "idHisRecib",
    "idRecib",
...
public class ActualizarReciboInternetRequest {

    @XmlElementRef(name = "autorizacion", namespace = "http://request.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> autorizacion;
    ...
    @XmlElementRef(name = "status", namespace = "http://request.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
     ...
     *     
     */
    public JAXBElement<String> getAutorizacion() {
        return autorizacion;
    }
     ...
     *     
     */
    public void setAutorizacion(JAXBElement<String> value) {
