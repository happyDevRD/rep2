...
/**
 * <p>Clase Java para ConsultaArchivoResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="ConsultaArchivoResponse"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="archivo" type="{http://dto.ge.gos.greenaall.es/xsd}ArchivoWs" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "ConsultaArchivoResponse", propOrder = {
    "archivo",
    "codigoRespuesta",
    "descripcion"
})
public class ConsultaArchivoResponse {
    ...
    protected List<ArchivoWs> archivo;
     ...
     * 
     */
    public List<ArchivoWs> getArchivo() {
        if (archivo == null) {
            archivo = new ArrayList<ArchivoWs>();
        }
        return this.archivo;
    }
