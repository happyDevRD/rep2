...
/**
 * <p>Clase Java para DatoConexion complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="DatoConexion"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "DatoConexion", propOrder = {
    "entidad",
    "municipio",
    "password",
    "usuario"
...
public class DatoConexion {
    ...
    @XmlElementRef(name = "entidad", namespace = "http://ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> entidad;
    @XmlElementRef(name = "municipio", namespace = "http://ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> municipio;
    @XmlElementRef(name = "password", namespace = "http://ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> password;
    @XmlElementRef(name = "usuario", namespace = "http://ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
