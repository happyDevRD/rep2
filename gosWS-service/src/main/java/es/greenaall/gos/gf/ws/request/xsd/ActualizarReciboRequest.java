...
/**
 * <p>Clase Java para ActualizarReciboRequest complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="ActualizarReciboRequest"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ActualizarReciboRequest", propOrder = {
    "datosConexion",
    "reciboCabecera"
})
public class ActualizarReciboRequest {
    ...
    @XmlElementRef(name = "reciboCabecera", namespace = "http://request.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
