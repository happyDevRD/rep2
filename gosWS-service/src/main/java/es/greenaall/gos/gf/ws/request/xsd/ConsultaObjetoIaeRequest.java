...
/**
 * <p>Clase Java para ConsultaObjetoIaeRequest complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="ConsultaObjetoIaeRequest"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="actividad" type="{http://request.ws.gf.gos.greenaall.es/xsd}IaeRequest" minOccurs="0"/&gt;
...
@XmlType(name = "ConsultaObjetoIaeRequest", propOrder = {
    "actividad",
    "datosConexion"
})
public class ConsultaObjetoIaeRequest {

    @XmlElementRef(name = "actividad", namespace = "http://request.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<IaeRequest> actividad;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link IaeRequest }{@code >}
     *     
     */
    public JAXBElement<IaeRequest> getActividad() {
        return actividad;
    }
     ...
     *     
     */
    public void setActividad(JAXBElement<IaeRequest> value) {
