...
/**
 * <p>Clase Java para ConsultaOperacionesRequest complex type.
 * 
 ...
 *         &lt;element name="operacion" type="{http://request.ws.gf.gos.greenaall.es/xsd}OperacionRequest" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ConsultaOperacionesRequest {
    ...
    @XmlElementRef(name = "operacion", namespace = "http://request.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<OperacionRequest> operacion;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link OperacionRequest }{@code >}
     *     
     */
    public JAXBElement<OperacionRequest> getOperacion() {
        return operacion;
    }
     ...
     *     
     */
    public void setOperacion(JAXBElement<OperacionRequest> value) {
