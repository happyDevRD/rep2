...
/**
 * <p>Clase Java para ConsultaModalidadProcedimientosRequest complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="ConsultaModalidadProcedimientosRequest"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ConsultaModalidadProcedimientosRequest", propOrder = {
    "datosConexion",
    "idMatProce"
})
public class ConsultaModalidadProcedimientosRequest {
