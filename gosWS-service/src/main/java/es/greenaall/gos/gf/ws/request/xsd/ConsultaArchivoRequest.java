...
/**
 * <p>Clase Java para ConsultaArchivoRequest complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="ConsultaArchivoRequest"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="archivo" type="{http://request.ws.gf.gos.greenaall.es/xsd}ArchivoRequest" minOccurs="0"/&gt;
...
@XmlType(name = "ConsultaArchivoRequest", propOrder = {
    "archivo",
    "datosConexion"
})
public class ConsultaArchivoRequest {

    @XmlElementRef(name = "archivo", namespace = "http://request.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<ArchivoRequest> archivo;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ArchivoRequest }{@code >}
     *     
     */
    public JAXBElement<ArchivoRequest> getArchivo() {
        return archivo;
    }
     ...
     *     
     */
    public void setArchivo(JAXBElement<ArchivoRequest> value) {
        this.archivo = value;
    }
