...
/**
 * <p>Clase Java para ConsultaAplicacionesRequest complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="ConsultaAplicacionesRequest"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="aplicacion" type="{http://request.ws.gf.gos.greenaall.es/xsd}AplicacionRequest" minOccurs="0"/&gt;
...
@XmlType(name = "ConsultaAplicacionesRequest", propOrder = {
    "aplicacion",
    "datosConexion"
})
public class ConsultaAplicacionesRequest {

    @XmlElementRef(name = "aplicacion", namespace = "http://request.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<AplicacionRequest> aplicacion;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link AplicacionRequest }{@code >}
     *     
     */
    public JAXBElement<AplicacionRequest> getAplicacion() {
        return aplicacion;
    }
     ...
     *     
     */
    public void setAplicacion(JAXBElement<AplicacionRequest> value) {
