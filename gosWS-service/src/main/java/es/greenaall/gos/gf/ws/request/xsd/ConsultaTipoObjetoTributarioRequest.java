...
/**
 * <p>Clase Java para ConsultaTipoObjetoTributarioRequest complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="ConsultaTipoObjetoTributarioRequest"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ConsultaTipoObjetoTributarioRequest", propOrder = {
    "datosConexion",
    "tipoObjetoTributario"
})
public class ConsultaTipoObjetoTributarioRequest {
