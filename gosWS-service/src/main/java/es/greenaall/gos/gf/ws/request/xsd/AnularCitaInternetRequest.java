...
/**
 * <p>Clase Java para AnularCitaInternetRequest complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="AnularCitaInternetRequest"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "AnularCitaInternetRequest", propOrder = {
    "datosConexion",
    "idCita"
})
public class AnularCitaInternetRequest {
    ...
    @XmlElementRef(name = "idCita", namespace = "http://request.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
