...
/**
 * <p>Clase Java para AutoliquidacionInternetWs complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="AutoliquidacionInternetWs"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="nomRepre" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
@XmlType(name = "AutoliquidacionInternetWs", propOrder = {
    "codEntid",
    "codPostaInter",
    "codPostaRepre",
    "corInter",
...
public class AutoliquidacionInternetWs {
    ...
    @XmlElementRef(name = "codPostaInter", namespace = "http://dto.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> codPostaInter;
    @XmlElementRef(name = "codPostaRepre", namespace = "http://dto.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> codPostaRepre;
    @XmlElementRef(name = "corInter", namespace = "http://dto.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "dirInter", namespace = "http://dto.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> dirInter;
    @XmlElementRef(name = "dirRepre", namespace = "http://dto.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> dirRepre;
    @XmlElementRef(name = "dniCifRepre", namespace = "http://dto.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "idAuto", namespace = "http://dto.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "movInter", namespace = "http://dto.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> movInter;
    @XmlElementRef(name = "movil", namespace = "http://dto.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> movil;
    @XmlElementRef(name = "munInter", namespace = "http://dto.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> munInter;
    @XmlElementRef(name = "munRepre", namespace = "http://dto.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> munRepre;
    @XmlElementRef(name = "nomRepre", namespace = "http://dto.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> nomRepre;
    @XmlElementRef(name = "nombreRepre", namespace = "http://dto.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "orden", namespace = "http://dto.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> orden;
    @XmlElementRef(name = "proInter", namespace = "http://dto.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> proInter;
    @XmlElementRef(name = "proRepre", namespace = "http://dto.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> proRepre;
    @XmlElementRef(name = "sesion", namespace = "http://dto.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> sesion;
    @XmlElementRef(name = "telInter", namespace = "http://dto.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> telInter;
    @XmlElementRef(name = "telefono", namespace = "http://dto.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    ...
    /**
     * Obtiene el valor de la propiedad nomRepre.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getNomRepre() {
        return nomRepre;
    }

    /**
     * Define el valor de la propiedad nomRepre.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setNomRepre(JAXBElement<String> value) {
        this.nomRepre = value;
    }
