...
/**
 * <p>Clase Java para ConsultaTramitacionRequest complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="ConsultaTramitacionRequest"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ConsultaTramitacionRequest", propOrder = {
    "datosConexion",
    "idExped",
    "idHisPerso",
    "idPerso"
})
public class ConsultaTramitacionRequest {
    ...
    @XmlElementRef(name = "idExped", namespace = "http://request.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
