...
/**
 * <p>Clase Java para ValidarUsuarioGosRequest complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="ValidarUsuarioGosRequest"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ValidarUsuarioGosRequest", propOrder = {
    "datosConexion",
    "pass",
    "usuario"
})
public class ValidarUsuarioGosRequest {
    ...
    @XmlElementRef(name = "pass", namespace = "http://request.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> pass;
    @XmlElementRef(name = "usuario", namespace = "http://request.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
