...
/**
 * <p>Clase Java para ValidaAgentePoliciaRequest complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="ValidaAgentePoliciaRequest"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="agente" type="{http://request.ws.gf.gos.greenaall.es/xsd}AgenteRequest" minOccurs="0"/&gt;
...
@XmlType(name = "ValidaAgentePoliciaRequest", propOrder = {
    "agente",
    "datosConexion"
})
public class ValidaAgentePoliciaRequest {

    @XmlElementRef(name = "agente", namespace = "http://request.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<AgenteRequest> agente;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link AgenteRequest }{@code >}
     *     
     */
    public JAXBElement<AgenteRequest> getAgente() {
        return agente;
    }
     ...
     *     
     */
    public void setAgente(JAXBElement<AgenteRequest> value) {
        this.agente = value;
    }
