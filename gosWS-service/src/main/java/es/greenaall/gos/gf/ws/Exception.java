...
import es.greenaall.util.comun.excepciones.xsd.CtrError;
...
public class Exception {
    ...
    @XmlElementRef(name = "Exception", namespace = "http://ws.gf.gos.greenaall.es", type = JAXBElement.class, required = false)
