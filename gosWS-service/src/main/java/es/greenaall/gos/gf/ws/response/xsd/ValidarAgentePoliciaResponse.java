...
/**
 * <p>Clase Java para ValidarAgentePoliciaResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="ValidarAgentePoliciaResponse"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="agente" type="{http://dto.gf.gos.greenaall.es/xsd}AgenteWS" minOccurs="0"/&gt;
...
@XmlType(name = "ValidarAgentePoliciaResponse", propOrder = {
    "agente",
    "codigoRespuesta",
    "descripcion"
})
public class ValidarAgentePoliciaResponse {
    ...
    @XmlElementRef(name = "agente", namespace = "http://response.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<AgenteWS> agente;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link AgenteWS }{@code >}
     *     
     */
    public JAXBElement<AgenteWS> getAgente() {
        return agente;
    }
     ...
     *     
     */
    public void setAgente(JAXBElement<AgenteWS> value) {
        this.agente = value;
    }
