...
/**
 * <p>Clase Java para UrbanaRequest complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="UrbanaRequest"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "UrbanaRequest", propOrder = {
    "idFinca",
    "idHisFinca",
    "idHisObjTribu",
    "idHisPerso",
...
public class UrbanaRequest {

    @XmlElementRef(name = "idFinca", namespace = "http://request.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> idFinca;
    @XmlElementRef(name = "idHisFinca", namespace = "http://request.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
