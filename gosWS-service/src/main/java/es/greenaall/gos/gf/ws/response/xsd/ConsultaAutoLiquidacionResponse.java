...
/**
 * <p>Clase Java para ConsultaAutoLiquidacionResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="ConsultaAutoLiquidacionResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ConsultaAutoLiquidacionResponse", propOrder = {
    "codigoRespuesta",
    "descripcion",
    "resultado"
})
public class ConsultaAutoLiquidacionResponse {
    ...
    @XmlElementRef(name = "resultado", namespace = "http://response.ws.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
