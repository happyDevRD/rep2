...
/**
 * <p>Clase Java para DescargarArchivoServidorRequest complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="DescargarArchivoServidorRequest"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "DescargarArchivoServidorRequest", propOrder = {
    "codArchi",
    "datosConexion"
})
public class DescargarArchivoServidorRequest {
