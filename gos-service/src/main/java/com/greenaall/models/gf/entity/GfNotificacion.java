...
public class GfNotificacion implements Serializable{
	...
	private static final long serialVersionUID = -7035410475777620597L;
    ...
    private BigInteger numRegisSalid;
	...
	public BigInteger getNumRegisSalid() {
		return numRegisSalid;
	}

	public void setNumRegisSalid(BigInteger numRegisSalid) {
