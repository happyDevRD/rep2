...
import es.gob.aapp.libreriaENI.converter.expediente.version2.ConverterFirmaExpedientV2;
...
@Service("ConverterFirmaExpedientV2")
public class ConverterFirmaExpedientV2Impl implements ConverterFirmaExpedientV2 {

    @Override
    public List<FirmaENI> converterFirmasEniToModel(Firmas firmas) throws ConverterException {
        // Segun el ENI del documento, si no existen firmas NO debera incluirse el nodo Firmas.
    ...
    public Firmas converterFirmasModelToEni(List<FirmaENI> firmas) throws ConverterException {
        // Segun el ENI del documento, si no existen firmas NO debera incluirse
        // el nodo Firmas.
