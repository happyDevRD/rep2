...
package es.gob.aapp.model.eni.v2.firma;
 ...
 * generated in the es.gob.aapp.model.eni.v2.firma package. 
...
public class ObjectFactory {
    ...
    private final static QName _Firmas_QNAME = new QName("http://administracionelectronica.gob.es/ENI/XSD/v2.0/firma", "firmas");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: es.gob.aapp.model.eni.v2.firma
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://administracionelectronica.gob.es/ENI/XSD/v2.0/firma", name = "firmas")
