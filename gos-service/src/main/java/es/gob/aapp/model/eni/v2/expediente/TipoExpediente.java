 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://administracionelectronica.gob.es/ENI/XSD/v2.0/expediente-e/indice-e}indice"/>
 *         &lt;element ref="{http://administracionelectronica.gob.es/ENI/XSD/v2.0/expediente-e/metadatos}metadatosExp"/>
 *         &lt;element name="VisualizacionIndice" type="{http://administracionelectronica.gob.es/ENI/XSD/v2.0/documento-e/contenido}TipoContenido" minOccurs="0"/>
 *         &lt;element name="metadatosAdicionales" type="{http://administracionelectronica.gob.es/ENI/XSD/v2.0/expediente-e}TipoMetadatosAdicionales" minOccurs="0"/>
 *       &lt;/sequence>
...
public class TipoExpediente {
    ...
    @XmlElement(namespace = "http://administracionelectronica.gob.es/ENI/XSD/v2.0/expediente-e/indice-e", required = true)
    protected TipoIndice indice;
    @XmlElement(namespace = "http://administracionelectronica.gob.es/ENI/XSD/v2.0/expediente-e/metadatos", required = true)
