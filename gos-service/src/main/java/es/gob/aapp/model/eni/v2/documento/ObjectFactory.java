 ...
 * generated in the es.gob.aapp.model.eni.v2.documento package. 
...
public class ObjectFactory {
    ...
    private final static QName _Documento_QNAME = new QName("http://administracionelectronica.gob.es/ENI/XSD/v2.0/documento-e", "documento");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: es.gob.aapp.model.eni.v2.documento
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://administracionelectronica.gob.es/ENI/XSD/v2.0/documento-e", name = "documento")
