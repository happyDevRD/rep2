...
public class Variable {
    ...
    @XmlElementRef(name = "obligatorio", namespace = "http://ws.dto.gf.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> obligatorio;
     ...
     *     
     */
    public JAXBElement<String> getObligatorio() {
        return obligatorio;
    }
     ...
     *     
     */
    public void setObligatorio(JAXBElement<String> value) {
