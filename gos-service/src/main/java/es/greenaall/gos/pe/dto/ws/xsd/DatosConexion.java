...
/**
 * <p>Clase Java para DatosConexion complex type.
 * 
...
public class DatosConexion {
    ...
    @XmlElementRef(name = "entidad", namespace = "http://ws.dto.pe.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> entidad;
    @XmlElementRef(name = "municipio", namespace = "http://ws.dto.pe.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> municipio;
    @XmlElementRef(name = "password", namespace = "http://ws.dto.pe.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> password;
    @XmlElementRef(name = "usuario", namespace = "http://ws.dto.pe.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
