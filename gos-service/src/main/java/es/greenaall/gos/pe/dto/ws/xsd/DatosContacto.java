...
/**
 * <p>Clase Java para DatosContacto complex type.
 * 
...
public class DatosContacto {
    ...
    @XmlElementRef(name = "correo", namespace = "http://ws.dto.pe.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> correo;
    @XmlElementRef(name = "movil", namespace = "http://ws.dto.pe.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> movil;
    @XmlElementRef(name = "telefono", namespace = "http://ws.dto.pe.gos.greenaall.es/xsd", type = JAXBElement.class, required = false)
